...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.renderTrackRightButtonHorizontalDefault = renderTrackRightButtonHorizontalDefault;
	exports.renderTrackLeftButtonHorizontalDefault = renderTrackLeftButtonHorizontalDefault;
	...
	function renderTrackRightButtonHorizontalDefault(_ref5) {
	...
	function renderTrackLeftButtonHorizontalDefault(_ref6) {
	    var style = _ref6.style,
	        props = _objectWithoutProperties(_ref6, ['style']);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Scrollbars = function (_Component) {
	    ...
	    function Scrollbars(props) {
	        ...
	        _this.getTrackHorizontalWidth = _this.getTrackHorizontalWidth.bind(_this);
	        ...
	        _this.doScrollLeft = _this.doScrollLeft.bind(_this);
	        _this.doScrollRight = _this.doScrollRight.bind(_this);
	    ...
	    _createClass(Scrollbars, [{
	        ...
	        key: 'getTrackHorizontalWidth',
	        value: function getTrackHorizontalWidth() {
	            var trackWidth = (0, _getInnerWidth2["default"])(this.trackHorizontal);
	            var leftButtonWidth = (0, _getInnerWidth2["default"])(this.leftButton);
	            var rightButtonWidth = (0, _getInnerWidth2["default"])(this.rightButton);
	        ...
	        value: function getThumbHorizontalWidth() {
	            ...
	            var trackWidth = this.getTrackHorizontalWidth();
	        ...
	        value: function doScrollRight(event) {
	            ...
	            var prev = this.getScrollLeft();
	            this.scrollLeft(this.getScrollLeft() + 50);
	            var current = this.getScrollLeft();

	            if (prev === current) {
	                var trackRightOverflowAction = this.props.trackRightOverflowAction;
	        ...
	        key: 'doScrollLeft',
	        value: function doScrollLeft(event) {
	            event.preventDefault();
	            event.stopImmediatePropagation();

	            if (this.getScrollLeft() === 0) {
	                var trackLeftOverflowAction = this.props.trackLeftOverflowAction;
	        ...
	        value: function _update(callback) {
	            ...
	            if ((0, _getScrollbarWidth2["default"])()) {
	                ...
	                var trackHorizontalWidth = this.getTrackHorizontalWidth();
	        ...
	        value: function render() {
	            ...
	            var _props5 = this.props,
	                ...
	                renderTrackRightButtonHorizontal = _props5.renderTrackRightButtonHorizontal,
	                renderTrackLeftButtonHorizontal = _props5.renderTrackLeftButtonHorizontal,
	            ...
	            var trackLeftButtonHorizontalStyle = _extends({}, _styles.trackLeftButtonHorizontalStyleDefault, autoHide && trackAutoHeightStyle, (!scrollbarWidth || universal && !didMountUniversal) && {
	                display: 'none'
	            });

	            var trackRightButtonHorizontalStyle = _extends({}, _styles.trackRightButtonHorizontalStyleDefault, autoHide && trackAutoHeightStyle, (!scrollbarWidth || universal && !didMountUniversal) && {
	                display: 'none'
	            });
	...
	Scrollbars.propTypes = {
	    ...
	    renderTrackRightButtonHorizontal: _propTypes2["default"].func,
	    renderTrackLeftButtonHorizontal: _propTypes2["default"].func,
	    renderTrackHorizontal: _propTypes2["default"].func,
	    renderTrackVertical: _propTypes2["default"].func,
	    renderThumbHorizontal: _propTypes2["default"].func,
	    renderThumbVertical: _propTypes2["default"].func,
	    trackLeftOverflowAction: _propTypes2["default"].func,
	    trackRightOverflowAction: _propTypes2["default"].func,
	...
	Scrollbars.defaultProps = {
	    ...
	    renderTrackRightButtonHorizontal: _defaultRenderElements.renderTrackRightButtonHorizontalDefault,
	    renderTrackLeftButtonHorizontal: _defaultRenderElements.renderTrackLeftButtonHorizontalDefault,
...
/***/ (function(module, exports) {
	...
	var trackRightButtonHorizontalStyleDefault = exports.trackRightButtonHorizontalStyleDefault = {
	    cursor: 'pointer',
	    position: 'absolute',
	    height: 10,
	    width: 10,
	...
	var trackLeftButtonHorizontalStyleDefault = exports.trackLeftButtonHorizontalStyleDefault = {
	    cursor: 'pointer',
	    height: 10,
	    width: 10,
	    display: 'flex',
